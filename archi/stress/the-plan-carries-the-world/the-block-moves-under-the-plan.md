...
carried: derived `the-close-re-reads-the-world-and-says-what-moved`. A copy into the plan
record was refused — it would put one scenario in two files and make the plan the second
place a person edits when a fact moves, which is the drift the world exists to remove. A
