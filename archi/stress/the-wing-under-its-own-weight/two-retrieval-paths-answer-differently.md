...
Ask the wing the same question two ways. `world ls --covers Worktree` walks `covers` and
...
the wing holds nothing about a node it in fact conditions, and stops looking; the decision
