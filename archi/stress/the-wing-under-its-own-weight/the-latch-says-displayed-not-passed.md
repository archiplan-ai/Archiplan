...
stories into the wing was that a Gherkin block is executable where free text was not, and
...
The wing pays the full cost of executable scenarios — a real parser, member tags, scenario
