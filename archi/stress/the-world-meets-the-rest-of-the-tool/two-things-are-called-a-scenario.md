...
and the standing requirement argues against exactly what the new world does.
...
into the world, and the reverse. The world looks like a durable home for the plan's
stories, people start writing them there, and the plan's exit ceremony quietly loses
the block it latches on.

## Resolution

One word, one thing: the world owns scenarios and the plan authors none. Derived
