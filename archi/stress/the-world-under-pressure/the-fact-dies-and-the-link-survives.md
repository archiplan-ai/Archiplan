...
purpose of the world, so this is the common path and not the rare one.
...
its authority exactly where the world was supposed to give it authority.
...
minting verb to the link set, along an axis the world already keeps: name the blast
