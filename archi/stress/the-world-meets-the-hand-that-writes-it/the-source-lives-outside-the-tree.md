...
signal the world has for grounding stops carrying information, and the count of
sourceless facts — the instrument that watches the world's health — measures the checker
...
exactly the way the world exists to prevent.
