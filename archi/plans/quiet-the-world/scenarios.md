...
- A plan on a tree that holds no world facts closes without a refusal, and the same plan on a tree that has a world refuses until a fact covers one of its nodes. Runs on cargo test (plan_e2e — no infrastructure).
