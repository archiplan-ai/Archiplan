...
- `archi/world/.worldignore` is read beside the wing; one line is `<element path> — <reason>`
...
- test — check_e2e: a wing of one fact reports a list that names no Data element
