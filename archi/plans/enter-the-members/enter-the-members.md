...
The resume page says where a cascaded seat's member worktrees lie and stops there. It
learns the three moves: switch into a standing member worktree, re-attach an absent one,
read the members' health on the way in.
