...
seat is the user's choice through the poll tool, never the agent's. A member checkout
outside the session's working directories is added to them before any git runs there. The
