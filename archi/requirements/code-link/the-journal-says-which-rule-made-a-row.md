...
The journal is append-only truth, so the inferred rows do not go away when the rule that made
them stops governing. They grade on every verify like every other row. Left
...
being read as claims a person stood behind.
