...
A plan pins a version so that code is written against a spec that holds still. The world
...
fact moves, which is the drift the world exists to remove. A report costs nothing to keep
