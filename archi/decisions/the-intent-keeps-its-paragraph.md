---
links: [the-intent-already-holds-the-world, world-facts]
prefer: [simplicity]
over: [correctness]
---

# The intent keeps its paragraph

An intent still opens with prose about the problem in the world, and nothing stops a claim
...
world prose in an intent means editing seventeen standing intents in this repository alone,
against a rule no check can enforce — whether a sentence is a falsifiable claim about the
world or context for a design is a judgement, not a parse. A rule that cannot be checked and
costs a migration buys nothing but the appearance of tidiness.
