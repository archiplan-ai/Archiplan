---
links: [world-facts, the-world-reports-what-stands-in-the-air, a-world-fact-carries-its-scenarios]
prefer: [simplicity]
over: [correctness]
---

# The world checks form and never truth
...
We take that cost, and it is the largest one the world carries. A false fact is worse
...
went away a year ago. The scenario lends its run to the fact beside it, so the world
...
can only guess at. Instead the world stays small enough to re-read whole, an empty
