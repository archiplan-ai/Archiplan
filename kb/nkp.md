...
| `WEIGHT_LABELED` | f_i derived from per-edge weights supplied at the analysis layer (`weight: Float ∈ [0,1]`, keyed by edge). The modeling language itself carries no attributes. |
